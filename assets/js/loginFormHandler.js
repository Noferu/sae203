document.addEventListener("DOMContentLoaded", function () {
  ...
  ); // Sélectionne l'icône pour afficher/masquer le mot de passe de confirmation
  ...
  if (togglePassword) {
    togglePassword.addEventListener("click", function () {
      const type =
        password.getAttribute("type") === "password" ? "text" : "password"; // Change le type du champ entre 'password' et 'text'
    ...
    toggleConfirmPassword.addEventListener("click", function () {
      const type =
        confirmPassword.getAttribute("type") === "password"
          ? "text"
          : "password"; // Change le type du champ entre 'password' et 'text'
